/*	The Tech Academy SQL Database Final Project - DATABASE/TABLE CREATION CODE
	This is an TSQL script to create a database for a fictional library.
	It contains tables to hold library branches, borrowerers, books, copies of books at each branch. publishers, book authors, and book loans.
	Table names and column names are self explanatory.
*/
